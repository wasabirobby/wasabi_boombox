...
local resourceName = "wasabi_boombox"

CreateThread(function()
    if GetCurrentResourceName() ~= "wasabi_boombox" then
        resourceName = "wasabi_boombox (" .. GetCurrentResourceName() .. ")"
    end
end)

CreateThread(function()
    while true do
        PerformHttpRequest("https://api.github.com/repos/wasabirobby/wasabi_boombox/releases/latest", CheckVersion, "GET")
        Wait(3600000)
    end
end)
...
GetRepoInformations = function()
    ...
    PerformHttpRequest("https://api.github.com/repos/wasabirobby/wasabi_boombox/releases/latest", function(err, response, headers)
        if err == 200 then
            ...
            repoURL = "https://github.com/wasabirobby/wasabi_boombox"
        end
    end, "GET")
